...
export const trapFocus = (element: HTMLElement): (() => void) => {
  if (!element) {
    console.error(
      '[a11y-core] trapFocus: element is null or undefined. Make sure to pass a valid DOM element.'
    );
    return () => {};
  }
  ...
  if (typeof document === 'undefined') {
    console.warn(
      '[a11y-core] trapFocus: Running in non-browser environment. Focus trap will be disabled.'
    );
    return () => {};
  }
